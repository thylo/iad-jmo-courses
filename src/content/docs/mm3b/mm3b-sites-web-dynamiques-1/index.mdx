...
- **Rashomon** (Kurosawa) : une histoire, plusieurs points de vue → votre clic choisit quelle version entendre
  Un crime dans la forêt. Quatre témoins racontent la même scène différemment. Aucune version n'est "la vraie".

<YouTube id='https://www.youtube.com/watch?v=L2E_DfExUmU' />

- **Mémento** (Nolan) : chronologie perturbée → vous décidez dans quel ordre explorer les souvenirs
  Un homme perd la mémoire à court terme. Le film raconte son histoire à l'envers pour qu'on ressente sa confusion.

<YouTube id="https://www.youtube.com/watch?v=sk4NyqHXT3Y" />

- **Run Lola Run** (Tykwer) : variations sur un même événement → votre vitesse change le déroulement
  Lola a 20 minutes pour sauver son copain. Le film rejoue trois fois la même histoire, chaque fois légèrement différente.

<YouTube id="https://www.youtube.com/watch?v=ZCYnsUdO6H0" />

- **Timecode** (Figgis) : écrans multiples simultanés → votre regard choisit quelle histoire suivre
  Quatre histoires se déroulent en simultané dans quatre cadres. À vous de suivre où vous voulez regarder.

<YouTube id="https://www.youtube.com/watch?v=YXr8W9i-Bz8" />

## Comment ce parcours est structuré

Chaque expérience est organisée en **deux pages complémentaires** :

1. **La pratique** : L'expérience, le code commenté, les défis progressifs. C'est ce qu'on explore ensemble en cours.
2. **La théorie** : Réfence consultable quand tu bloques. Pas à lire d'un coup, mais à chercher au besoin.

Les deux se parlent et se renvoient l'une vers l'autre.
...
### 1. Clickclickclick - Les bases (pratique + théorie)
**Interaction** : Clics partout
**Concept narratif** : Chaque action est enregistrée
**Référence** : Critique de la surveillance web

📌 **[Clickclickclick - La pratique →](clickclickclick-pratique)** (en cours)
📚 **[JavaScript - Fondamentaux →](javascript-fondamentaux)** (référence théorique)

---

### 2. Le personnage qui vous observe
